...
class LookupManager(BaseManager):
    ...
    def get_node_by_dsl(self, node: BaseEntity) -> Node | None:
    ...
    def get_edge_by_hash(self, edge_hash: str) -> Edge | None:
    ...
    def get_citation_by_pmid(self, pubmed_identifier: str) -> Citation | None:
    ...
    def get_citation_by_reference(self, db: str, db_id: str) -> Citation | None:
    ...
    def get_citation_by_curie(self, curie: str) -> Citation | None:
    ...
    def get_evidence_by_hash(self, evidence_hash: str) -> Evidence | None:
        """Look up an evidence by its hash."""
        return self.session.query(Evidence).filter(Evidence.md5 == evidence_hash).one_or_none()

    def get_evidence_by_reference_text(self, db: str, db_id: str, text: str) -> Evidence | None:
    ...
    def get_evidence_by_citation_text(self, citation: Citation, text: str) -> Evidence | None:
