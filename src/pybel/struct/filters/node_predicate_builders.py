...
def function_inclusion_filter_builder(func: Strings) -> NodePredicate:
    ...
    raise TypeError(f"Invalid type for argument: {func}")
...
def data_missing_key_builder(key: str) -> NodePredicate:
...
def namespace_inclusion_builder(namespace: Strings) -> NodePredicate:
    ...
    if isinstance(namespace, str):
        ...
        raise TypeError(f"Invalid type for argument: {namespace}")
