...
# of the sidebar.
#
html_logo = "PyBEL-square-100.png"
...
latex_documents = [
    (master_doc, "PyBEL.tex", "PyBEL Documentation", "Charles Tapley Hoyt", "manual"),
]
...
man_pages = [(master_doc, "pybel", "PyBEL Documentation", [author], 1)]
